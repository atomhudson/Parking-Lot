...
public class Main {
            ...
            try {
                ...
                switch (type) {
                    case CREATE_PARKING_LOT:
                        ...
                        break;
                    case PARK_VEHICLE:
                        // Ensure correct parsing of VehicleType first
                        VehicleType vehicleType = VehicleType.valueOf(scanner.next().toUpperCase());  // Convert to enum
                        String registrationNumber = scanner.next();  // Registration number as string
                        String vehicleColor = scanner.next();  // Vehicle color
                        parkingLotService.parkVehicle(vehicleType, registrationNumber, vehicleColor);
                        break;
                    case UNPARK_VEHICLE:
                        parkingLotService.unParkedVechile(scanner.next());
                        break;
                    case DISPLAY:
                        parkingLotService.display(DisplayType.valueOf(scanner.next().toUpperCase()), VehicleType.valueOf(scanner.next().toUpperCase()));
                        break;
                    case EXIT:
    ...
    private static void printHelp() {
        ...
        System.err.println(GREEN + "Vehicle Types: " + RESET + vehicleTypes);
        ...
        System.err.println(GREEN + "Display Types: " + RESET + displayTypes);
    }
}
